...
# Start metrics store
docker-compose -f ./docker-compose-metricstore.yml up -d --remove-orphans
...
cat >~/.benchmark/benchmark.ini <<EOF
[meta]
config.version = 17
...
[node]
root.dir = /home/ankikala/.benchmark/benchmarks
src.root.dir = /home/ankikala/.benchmark/benchmarks/src
...
[benchmarks]
local.dataset.cache = /home/ankikala/.benchmark/benchmarks/data
